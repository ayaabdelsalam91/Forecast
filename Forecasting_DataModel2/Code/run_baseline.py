...
FeaturesCount = 16
TrainData , TrainOutput , Trainseq_length ,  TestData, Testseq_length , RID = Model1_getLSTMData ('TrainingDS' , 'TestingDS', FeaturesCount, timeSteps = 104, isTargetReplication = False , hasID=False , hasMonth=True)

print(Testseq_length)

Baseline_LSTM('BL_500' , TrainData , TrainOutput , Trainseq_length ,  TestData, Testseq_length , 
